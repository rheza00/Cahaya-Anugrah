    ...
    $routeProvider
        ...
        .when("/Masuk", {
            template: <div class="bg-form">
                ...
                <a href="#!Masuk" class="nav-link"><h4>Masuk</h4></a>
                <div class="row">
                <p><sub>atau</sub></p>
                <a href="#!Daftar" class="nav-link"><h6>Daftar</h6></a>
                </div>
                </div>
                ...
                <button type="submit" style="margin-bottom: 115px; margin-top: 40px;" class="btn btn-primary btn-lg btn-block">Masuk</button>
                </form>
                </div>
                </div>'
        })
        ...
        .when("/Daftar", {
            template: <div class="bg-form">
                ...
                <a href="#"><div class="close">+</div></a>
                <div class="row" style="justify-content: space-between;">
                <a href="#!Daftar" class="nav-link"><h4>Daftar</h4></a>
                <div class="row">
                <p><sub>atau</sub></p>
                <a href="#!Masuk" class="nav-link"><h6>Masuk</h6></a>
                </div>
                </div>
                <form class="was-validated">
